...
<div class="card-columns">
  ...
  <div class="card">
    <a href="https://arxiv.org/abs/2601.21511" target="_blank">
      <img class="img-fluid mb-2" src="/img/llamea/llamea-sage-final.png" alt="LLaMEA-SAGE: Guiding Automated Algorithm Design with Structural Feedback from Explainable AI"/>
    </a>
    <div class="card-body">
...
<div class="card-columns">
  ...
  <div class="card">
    <a href="https://arxiv.org/abs/2603.02792" target="_blank">
      <img class="img-fluid mb-2" src="/img/llamea/llamea-priors-final.png" alt="From Heuristic Selection to Automated Algorithm Design: LLMs Benefit from Strong Priors"/>
    </a>
    <div class="card-body">
...
<div class="card-columns">
  ...
  <div class="card">
    <a href="https://arxiv.org/abs/2602.04529" target="_blank">
      <img class="img-fluid mb-2" src="/img/llamea/llamea-proxy.png" alt="Landscape-aware Automated Algorithm Design: An Efficient Framework for Real-world Optimization"/>
    </a>
    <div class="card-body">
  ...
  <div class="card">
    <a href="https://arxiv.org/abs/2601.18846" target="_blank">
      <img class="img-fluid mb-2" src="/img/llamea/llamea-problems.png" alt="LLM Driven Design of Continuous Optimization Problems with Controllable High-level Properties"/>
    </a>
    <div class="card-body">
